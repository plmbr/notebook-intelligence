...
| `NBI_ENABLE_CHATBOOK`                            | bool | `true`                      | env / traitlet `enable_chatbook`             | Enable Chatbook. Default on so users need no env var. Set `false` to hide the Chatbook kernelspec, Settings tab, launcher tile, and generate/mention APIs. See [`docs/chatbook.md`](chatbook.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `NBI_CHATBOOK_MAX_EXECUTION_MODE`                | str  | `auto-run`                  | env / traitlet `chatbook_max_execution_mode` | Cap Chatbook natural-language execution. Users cannot pick a more permissive mode. Values: `always-confirm`, `confirm-if-risky`, `auto-run`. See [`docs/chatbook.md`](chatbook.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| `/notebook-intelligence/chatbook/generate`                  | POST            | Chatbook cell codegen, English summary (`operation=summarize`), or optional danger classifier (`operation=danger_scan`). See [`docs/chatbook.md`](chatbook.md).                                                                                                                                     |
