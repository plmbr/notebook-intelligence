...
| `NBI_CHATBOOK_MAX_EXECUTION_MODE`                | str  | `auto-run`                  | env / traitlet `chatbook_max_execution_mode` | Cap Chatbook natural-language execution. Users cannot pick a more permissive mode. Values: `generate-only`, `always-confirm`, `confirm-if-risky`, `auto-run`. See [`docs/chatbook.md`](chatbook.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
